const categories = {
    "Infectious Diseases": [
        ...
        {
            question: "Which diagnostic test is commonly used to detect Dirofilaria immitis antigen in dogs?",
            options: ["Blood smear", "ELISA test", "PCR test", "Radiographs"],
            answer: 1,
            explanation: "An in-clinic ELISA antigen test is the standard for confirming heartworm infection."
        },
        {
            question: "Which antimicrobial is recommended for treating Bartonella henselae infection in cats?",
            options: ["Amoxicillin-clavulanate", "Doxycycline", "Metronidazole", "Marbofloxacin"],
            answer: 1,
            explanation: "Doxycycline is commonly used due to its efficacy against Bartonella."
        }
    ],
    "Endocrine": [
        {
        ...
        {
            question: "Which electrolyte abnormality is commonly seen with hypoadrenocorticism?",
            options: ["Hypernatremia", "Hyperkalemia", "Hypokalemia", "Hypercalcemia"],
            answer: 1,
            explanation: "Lack of aldosterone results in potassium retention leading to hyperkalemia."
        },
        {
            question: "What is the treatment of choice for cats with hyperthyroidism?",
            options: ["Methimazole", "Thyroxine", "Radioiodine therapy", "Surgery"],
            answer: 2,
            explanation: "Radioiodine therapy destroys overactive thyroid tissue and is considered curative."
        }
    ],
    "Gastrointestinal": [
        {
        ...
        {
            question: "Which antibiotic is indicated for treatment of Helicobacter-associated gastritis in dogs?",
            options: ["Metronidazole", "Enrofloxacin", "Clindamycin", "Amoxicillin"],
            answer: 3,
            explanation: "Amoxicillin is part of the standard triple therapy for Helicobacter gastritis."
        },
        {
            question: "What is the most common cause of chronic vomiting in middle-aged cats?",
            options: ["Pancreatitis", "Inflammatory bowel disease", "Gastric lymphoma", "Hairballs"],
            answer: 1,
            explanation: "Inflammatory bowel disease is a frequent diagnosis after systemic causes are ruled out."
        }
    ],
    "Cardiovascular": [
        {
        ...
        {
            question: "Which diagnostic imaging modality best quantifies left atrial size in dogs with mitral valve disease?",
            options: ["Abdominal ultrasound", "Thoracic radiographs", "Echocardiography", "CT scan"],
            answer: 2,
            explanation: "Echocardiography provides accurate assessment of atrial dimensions."
        },
        {
            question: "Which arrhythmia is characterized by an absence of P waves and an irregularly irregular rhythm in dogs?",
            options: ["Atrial fibrillation", "Ventricular tachycardia", "AV block", "Sinus bradycardia"],
            answer: 0,
            explanation: "Atrial fibrillation presents with no discernible P waves and a chaotic rhythm."
        }
    ],
    "Respiratory": [
        {
        ...
        {
            question: "Which vaccine helps protect dogs from kennel cough complex by targeting Bordetella bronchiseptica?",
            options: ["DA2PP", "Rabies", "Leptospirosis", "Intranasal Bordetella vaccine"],
            answer: 3,
            explanation: "The intranasal Bordetella vaccine provides mucosal immunity against kennel cough."
        },
        {
            question: "Which diagnostic test is most useful for confirming feline chronic bronchitis?",
            options: ["Thoracic radiographs", "Bronchoscopy with bronchoalveolar lavage", "Complete blood count", "Echocardiography"],
            answer: 1,
            explanation: "Bronchoscopy with BAL allows cytology and culture to confirm inflammatory bronchitis."
        }
    ],
    "Renal": [
        {
        ...
        {
            question: "Which fluid therapy is recommended for dogs in acute kidney injury with oliguria?",
            options: ["Restricted fluids", "Aggressive IV fluids to rehydrate then maintain", "No fluids", "Oral electrolyte solutions only"],
            answer: 1,
            explanation: "Aggressive IV fluids correct dehydration and support renal perfusion."
        },
        {
            question: "What drug can reduce proteinuria in dogs with glomerular disease?",
            options: ["Prednisone", "Enalapril", "Atenolol", "Furosemide"],
            answer: 1,
            explanation: "ACE inhibitors like enalapril lower glomerular pressure and reduce protein loss."
        }
    ],
    "Neurology": [
        {
        ...
        {
            question: "Which diagnostic test is most appropriate for diagnosing myasthenia gravis in dogs?",
            options: ["Electroencephalography", "Acetylcholine receptor antibody titer", "CSF analysis", "Myelography"],
            answer: 1,
            explanation: "An elevated acetylcholine receptor antibody titer confirms immune-mediated myasthenia gravis."
        },
        {
            question: "Which medication is used to treat neuropathic pain in cats with spinal disease?",
            options: ["Prednisone", "Gabapentin", "Tramadol", "Enrofloxacin"],
            answer: 1,
            explanation: "Gabapentin is frequently prescribed for neuropathic pain."
        }
    ],
    "Oncology": [
        {
        ...
        {
            question: "Which tumor is most commonly associated with FeLV infection in cats?",
            options: ["Osteosarcoma", "Lymphoma", "Mast cell tumor", "Hemangiosarcoma"],
            answer: 1,
            explanation: "FeLV-positive cats have a high incidence of lymphoma."
        },
        {
            question: "What chemotherapeutic agent is used to treat canine lymphoma as part of the CHOP protocol?",
            options: ["Vincristine", "Cyclophosphamide", "Doxorubicin", "All of the above"],
            answer: 3,
            explanation: "The CHOP protocol uses vincristine, cyclophosphamide, doxorubicin, and prednisone."
        }
    ]
};
